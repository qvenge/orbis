...
| Что меряем | Как | Цель (00-product §8) |
|---|---|---|
| time-to-log расхода, fast-path | от нажатия «отправить» в чате до появления карточки «⚡ без AI» | < 2 сек |
| time-to-log расхода, путь LLM | от отправки формулировки, которую fast-path не берёт, до карточки | < 5 сек |
| Первая отрисовка Budget Overview | от тапа по вкладке Budget до появления конвертов с суммами | < 2 сек |
| Первая отрисовка Agenda | от тапа по вкладке Agenda до появления дневных секций | < 2 сек |
