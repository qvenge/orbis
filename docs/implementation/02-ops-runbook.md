...
| Второй LLM-провайдер (OpenAI) | ничего: схема аспектов не менялась — работа шла в `apps/server/src/llm/*` и в конфиге. Пересев не нужен; предусловие деплоя другое — `OPENAI_API_KEY` в Render UI до выкатки (§1) |
