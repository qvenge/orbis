...
keep-warm против сна Render, пауза Supabase Free, health-мониторинг и перф-чек-лист релиза.
...
(`diffBuiltinAspects` в `@orbis/shared`) — расхождения между ручной и автоматической
проверкой быть не может по построению.
...
меряет шесть горячих операций на засеянном объёме (2000 сущностей, 1000 транзакций,
...
|---|---|---|---|---|---|---|
| — | — | — | — | — | — | первый релиз со слайса 3 заполняет строку |
