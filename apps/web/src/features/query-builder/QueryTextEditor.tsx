...
// пара символов зовётся QUERY_BLOCK_CLOSE: этот файл открывается рядом с редактором блока, и
// импорт схемы документа ради двух символов утащил бы её вес не в тот чанк. Путь `@orbis/shared`
// у файла и без того есть (parseQuery), новых рёбер в графе сборки импорт не добавляет.
