...
// паузу.
//
// Место — карточка рутины (`{{card: orbis/routine}}`, own-cards.tsx), в шаблоне хоста — на вкладке
// «Запись» над телом-инструкцией: рутину открывают ради того, что она делает и делает ли вообще.
// Правка расписания и прав — секцией полей аспекта в той же карточке (В4); здесь только показ и
// переключатель паузы, и это не половина
