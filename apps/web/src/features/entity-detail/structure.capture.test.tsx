 ...
 * экрана сделала бы сравнение задачи 14 тавтологией. Файл остаётся в репозитории как запись о
 * том, КАК эталон получен (те же фикстуры, тот же обработчик, та же стабилизация), а не как
