      ...
      <dd>
        ...
        >
          {/* Своя опция под текущее значение, пока список грузится или ссылка ведёт
              ...
              isError — ОТДЕЛЬНАЯ ветка (приём RolloverScreen): упавший запрос даёт тот
              же пустой список, и общий текст «Категория не найдена» врал бы про целую
              транзакцию, будто связь с категорией потеряна. */}
          {!known && (
            <option value={value}>
              {q.isError
