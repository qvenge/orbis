 ...
 *
 * Родитель у неё с этой задачи ОДИН: на самой записи строки рисует `PropertyRow`
 * (`AspectSection.tsx`), и контрол там выбирается по типу свойства из реестра. У строки предложения такого выбора
