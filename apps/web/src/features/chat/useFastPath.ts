 ...
 * подписи в ленте молча менялись бы. Русские подписи ставит реестр (`registry.effective`,
 * §А9-2) — с Задачи 13a он адресует свойства ровно этими id, и сырыми ключи видны только
 * до прихода первого снимка.
 */
