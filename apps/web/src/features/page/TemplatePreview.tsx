 ...
 *
 * Запись в предпросмотре — только чтение целиком (`readOnly`): запись взята для примера, и ни
 * заголовок, ни карточки, ни тред, ни тело на ней не правятся (§0.2 п. 2, 1а новое-5).
 *
...
/** Шаблон на выбранной записи — её данными, только для чтения целиком. */
function PreviewOn({
  recordId,
  template,
}: {
