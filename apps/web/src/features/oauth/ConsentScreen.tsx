  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-4 p-6">
      ...
      <p className="text-sm text-text-secondary">
        Агент сможет читать и изменять ваши записи от вашего имени. Действия попадут в журнал,
...
const SCOPE_OPTIONS: ReadonlyArray<{ value: GrantScope; title: string; hint: string }> = [
  ...
  },
  {
    ...
    hint: 'Исполнитель видит граф и пишет только через глаголы задач; закрывает тикет только с явного разрешения владельца (may_close).',
  },
];
