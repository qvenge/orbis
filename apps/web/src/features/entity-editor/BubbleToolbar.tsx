 ...
 * родителю. Это не осторожность вообще, а конкретная защита: наивное расширение «пока родитель
 * покрыт» ломает таблицу в один столбец ровно так же, как это делал ручной подъём раунда 2
 * (замерено ревью). Словарь тот же, что у `ownBlock`, — правило гранулярности и правило уборки
 * говорят об одном и том же понятии «список», и разъехаться им нечем.
 *
