 ...
 * заметкой, от которой экран отказывается сознательно (DetailScreen.tsx:373); молчание здесь и
 * означает «всё сохранено». Показать есть что ровно в двух случаях: запрос идёт дольше секунды
 * и правка не сохранена.
 *
