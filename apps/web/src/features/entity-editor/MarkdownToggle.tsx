...
export function MarkdownToggle({
  ...
  // Снимок на момент открытия: набранное пользователем НЕ перетирается приходящим `doc`
  // (автосохранение Задачи 13 отдаёт новый объект документа на каждый круг записи).
