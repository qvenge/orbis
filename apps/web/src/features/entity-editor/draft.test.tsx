...
//
// «Прошлое» выражено как `DOC_SCHEMA_VERSION - 1`, а не литералом: конверсия черновика
// (`upgradeBodyDoc`) знает ровно ОДИН шаг — с предыдущей версии на текущую, — и произвольно
// старая версия честно уходит к человеку («конвертировать нечем»). Литеральный `0` пережил бы
// поднятие версии зелёным, сторожа при этом ветку, которой больше нет.
