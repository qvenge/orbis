...
export const TEST_CALL_ASPECT: CustomAspectSpec = {
  ...
  // Множество цели — Q-AST, а не строка: форма взята у ссылочного свойства фикстур гейта
  // (`fixtures/gate-aspects.ts`), но БЕЗ их токенов — дисциплина §С8-18 запрещает писать имена
  // полей гейта где-либо, кроме самой фикстуры, снимка и своего теста. Валидатору `deref`
