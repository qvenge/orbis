 ...
 *    отменяет саму реформу. Колонка `entities.meta` доживает до 0017, но наружу не едет:
 *    читателя у неё в web нет ни одного;
 ...
 *    Проекция для не переведённых читателей осталась ровно одна и внутри сервера
 *    (`executor/legacy-form.ts`, `projectLegacyAspects`) — до «Пересева мира».
 */
