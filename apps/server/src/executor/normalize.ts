 ...
 * - после отключения id свободен для своего правила на ДРУГОМ носителе, и поиск «по id по всему
 *   снимку» подменял бы идентичность чужим набором (перенос переживал бы смену валюты). Носитель задан
 *   явно — порядок строк снимка и второе правило уникальности конверта (§Б4-1) не решают ничего.
 *
