...
// в части Б (Б-2), и до неё имя `nearest_ancestor` живёт двумя литералами — во флаге
// `flags.computed.rule` встроенных свойств и в полезной нагрузке журнала ниже. Разъехаться
// им нельзя, поэтому оба смотрят на одну константу RULE_ID.
//
...
/** Имя правила: то же, что во `flags.computed.rule` встроенных свойств (§А8). */
export const RULE_ID = 'nearest_ancestor';
