...
//
// Движок пересчёта — код; его ПАРАМЕТРЫ — строка каталога (с Б-2). Пара целевых свойств, аспект-носитель
// и кап глубины приезжают строкой правила `nearest_ancestor` на `orbis/project`
