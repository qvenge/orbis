 ...
 * `property_definitions`. Правило пиннится тестом, который ведётся ОТ реестра тулов и падает
 * на первой же фразе, написанной иначе.
 *
 ...
 * диспатч доходят не все фразы (у части тулов уровень выше `preview`, а фразы четырёх тулов
 * задачи 16 написаны РАНЬШЕ самих тулов), и перебор по реестру возможен только отсюда.
 *
