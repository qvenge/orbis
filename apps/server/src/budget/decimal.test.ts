...
describe('decMul: умножение decimal×decimal — точно, без округления', () => {
  ...
  test('порог 0.85 ВКЛЮЧИТЕЛЬНО: decCmp(spent, decMul(limit, "0.85")) ≥ 0 ≡ прежний порог целыми 20·spent ≥ 17·limit', () => {
    ...
    // «тревогой» (целыми, как считал снесённый срезом Б-2 оракул: 20·85.03 = 1700.60 <
    // 17·100.04 = 1700.68 — не тревога).
