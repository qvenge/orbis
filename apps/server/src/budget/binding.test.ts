...
// четвёрки (константа в `executor/normalize.ts`) снята, `dropStaleCarryover` читает реестр.
// ---------------------------------------------------------------------------
...
// (тогда — код уникальности конверта на prepare) и ждало строки — цикл ожидания, который
// PostgreSQL разрывает отказом одной из транзакций по дедлоку.
// ---------------------------------------------------------------------------
