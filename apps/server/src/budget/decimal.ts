 ...
 * округлённый до двух знаков, сдвинул бы вердикт на конверте с копеечным лимитом: 0.85 · 100.04 =
 * 85.034, округлённое — 85.03, и spent = 85.03 из «не тревога» (у оракула 20·85.03 = 1700.60 <
 * 17·100.04 = 1700.68) стал бы «тревога». Сдвиг даёт округление ВНИЗ; вверх (85.0085 → 85.01)
