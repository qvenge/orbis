...
// §С8-18). В «Сегодня» рядом с `class=orbis/completable:open` ОСТАЁТСЯ конструкция
// `orbis/task_status=!waiting`: `open` включает и ожидающие, и свёртка трёх отрицаний в
// набор вернула бы их в блок, то есть поменяла бы наблюдаемое поведение.
