...
export type ExecErrorCode =
   ...
   *  Бросает `assertAction` (задача 6) — при ЗАПИСИ декларации. На исполнении отказа нет: факты
   *  шагов объединяются с фактами декларации (`actionCallFacts`, `actions/run.ts`), и уровень не
   *  считается по неполному набору (задача 7). */
