...
/**
 * Состояние пачки, которое видит сборщик рёбер: виртуальные рёбра (`created` — итог пачки по
 * создаваемым рёбрам любой роли: общий пре-пасс исполнителя, Р-К-46, созданное и снятое той же пачкой
 * в него не входит; `deleted` — снятые пачкой рёбра БД) и архивность строк, уже
