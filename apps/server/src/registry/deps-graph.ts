 ...
 * «свойство → правило → свойство» (`rule`) приехало срезом Б-2; сторожа зовут врезки записи
 * (`registry/rules.ts`: `assertRulesOfRow` на записи строки с правилами, `assertBuiltinRules`
 * над снимком из кода).
 *
