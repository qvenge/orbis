...
// сырые SQL-запросы бюджета, круга исполнителя, компилятора грамматики §6 и чтения
// backlinks. Их вызывающие держат `tx` и не держат `RegistrySnapshot`, а тащить снимок
