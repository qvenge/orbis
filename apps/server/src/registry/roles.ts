...
// в снимок; признак, по которому следующий читатель поймёт, что момент настал:
// `REGISTRY_DELTA_TARGET_KINDS` перестал отвергать цель `relation_role` в `applyDeltas`.
//
