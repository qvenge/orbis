...
describe('корпус §С1-2: состав', () => {
  test('21 строка, 24 имени кода, жанры 17/4, порч ≥ 1 на строку, красных нет', () => {
    ...
    // Последние три (3/15/18) закрыл валидатор действий задачи 6. Выбор пометки ниже и поле `red`
    // снимает задача 17 вместе с файлом из `PENDING_MARK_FILES`; до неё вернувшуюся красную строку
    // ловит ЭТОТ пин — имена строк, а не число.
