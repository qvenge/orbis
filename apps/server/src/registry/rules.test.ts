...
/**
 * Системных строк каталога правил — тринадцать: задача 4 — два инварианта §А7-2 (financial — парой)
 ...
 * «чего ждём» парой (`waiting_for`, `waiting_for_only_when_waiting`).
 */
const BUILTIN_RULE_COUNT = 13;
