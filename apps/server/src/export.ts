 ...
 * нет вовсе; строк контрактов, привязок, подписок и действий, дельт правил и своих правил строк —
 * эти реестры с Б-1/Б-2 живут, но в дамп не попадают (реестр остатков Б-2, строка 99: экспорт §С5 —
