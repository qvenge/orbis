 ...
 * докблоке `grantsRoutineAutonomy` ниже; читает адрес проба состояния
 * (`autonomyChangedByCarrier`, `tools/dispatch.ts`), а дом у него один — здесь, рядом с
 * остальными адресами рутины, и он пиннится к реестру тем же тестом.
 */
 ...
 * |----------|----------------------------------|---------------------------------------|
 * | аспект   | `detach` — ДЕРЖИТСЯ (Р-12-3)     | `attach` — ДЕРЖИТСЯ (Р-12-5)          |
 * | архив    | `archived: true` — ряд §7.10     | `archived: false` — ДЕРЖИТСЯ (Р-12-6) |
 * | `stage`  | пауза — у владельца (Р-12-4)     | снятие паузы — ДЕРЖИТСЯ (Р-12-4 испр.)|
 *
