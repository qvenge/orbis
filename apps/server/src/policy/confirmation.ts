 ...
 * снять архив с приостановленной) проходит МОЛЧА, и это не дыра: рутина от него не работает, а
 * вызов, который её включит, упрётся в замок. Внутри `batch_execute` считается то же самое —
