 ...
 * Новая колонка «не предлагать модели» — миграция, которой срез 1а не делает (спека §12). Список
 * убирает аспект только от модели; core-тулы его по-прежнему принимают, а границу держит
 * `aiInstructions` аспекта.
 */
