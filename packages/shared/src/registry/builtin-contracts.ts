...
const ENTRIES: readonly (SlotsEntry | FactsEntry)[] = [
...

  {
    ...
    // Набор `facts` (E-предикат «не план ∧ дата ≤ сегодня ∧ не шаблон») досевает задача 4:
    // схема наборов до неё знает только списки классов.
    sets: { outflow: ['outflow'], inflow: ['inflow'] },
    module: 'finance',
  },
