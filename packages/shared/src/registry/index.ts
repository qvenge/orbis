...
export * from './row';
// Форма правила каталога (§Б4-1) — в барреле по тому же доводу, что и `subscription-fixtures`
// ниже: здесь только литералы и схемы, ни одного `parse` на загрузке модуля, а читают их обе
// стороны — валидатор сервера (`registry/rules.ts`) и фикстуры приёмки.
