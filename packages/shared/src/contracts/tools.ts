 ...
 *
 * `prefix` — набранный фрагмент; имя описывает ввод, а не способ сопоставления. Ищется он
 * как ВХОЖДЕНИЕ в заголовок (иначе «Отчёт за квартал» перестал бы находиться набором
 * «квартал»), а совпадения с начала заголовка ранжируются выше — детали у процедуры.
 *
