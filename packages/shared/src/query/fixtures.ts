 ...
 * с уходом `aspectsMap` из wire-формы, а её переводчик — «Пересевом мира»: адрес значения
 * теперь один, и второго перевода тех же полей в репозитории нет по построению.
