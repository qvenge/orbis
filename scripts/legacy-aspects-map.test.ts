...
// СТРАЖ Задачи 23a: старой карты аспектов «ключ `aspects` с объектом из id аспекта в поля»
// в тестовых файлах репозитория больше нет.
//
...
// код старой карты не пишет вовсе, а миграции и `legacy-form.ts`/`legacy-field-map.ts`
// описывают её по своему назначению и умирают вместе с ней (23b).
